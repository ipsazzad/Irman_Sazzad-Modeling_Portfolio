...
put TM;
TM.nd=6;
put "Results, step, CV, PD_pct, w_pct, r_pct, PX_pct, PQ_pct, HHX_pct, LAB_pct, CAP_pct, Q_pct, QM_pct, X_pct, XE_pct, QD_pct, INC_pct, PL_pct" /;
loop((tt,i),
    put ord(tt), CV(tt), PD_pct(i,tt), w_pct(tt), r_pct(tt), PX_pct(i,tt), PQ_pct(i,tt), HHX_pct(i,tt), LAB_pct(i,tt), CAP_pct(i,tt), Q_pct(i,tt), QM_pct(i,tt), X_pct(i,tt), XE_pct(i,tt), QD_pct(i,tt), INC_pct(tt), plevel(tt) /
);
putclose;